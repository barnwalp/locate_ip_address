...
const map_init = function() {
  console.log(lat, lang, region, country, isp);
...
var show_location = function(lat, lang, region, country, isp) {
  //marker
...
*/
map_init();
show_location(lat, lang, region, country, isp);

input_bar = document.getElementById('ip-search');
submit = document.querySelector('.submit-button');
elem_ip = document.getElementById('ip');
elem_region = document.getElementById('region');
elem_country = document.getElementById('country');
elem_isp = document.getElementById('isp');
...
submit.addEventListener('click', function(){
  ...
  if (match) {
    ...
    country = data[3];
    isp = data[4];
    elem_ip.textContent = ip_address;
    elem_region.textContent = region;
    elem_country.textContent = country;
    elem_isp.textContent = isp;
    show_location(lat, lang, region, country, isp);
  } else {
